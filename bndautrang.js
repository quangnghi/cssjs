...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='http://facebook.com/shoplenny' target='_blank'><img src='http://lenny.vn/https://lh3.googleusercontent.com/-QU5NX4H3z_w/V82KtPO5T7I/AAAAAAAACNc/wSTFgXrBngg_s1aha0p7l_MdYXd2tU_SgCL0B/s507-no/rBVaG1Zh2oyAQHWTAADxt6R83s4142.jpg.jpg' width='500px'/><br/>ao khoac nam </a>. Áo khoác nam cao cấp chất lượng. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
			jQuery('#myModal').http://facebook.com/shoplenny(jQuery('#myModal').data());
		}
});
